		...
		<Box>
			...
			>
				...
				<Button 
					height='auto'
					width={250}
				onClick={ () => pEditDesc(id, desc)}>Add Description</Button>
			</Box>
			<Box
				px={px}
				py={py}
			...
			>
				...
				<Button 
					width={250}
				onClick={ () => pEditMaxAccepted(id, maxAccepted)}>Add Max Accepted</Button>
			</Box>
			<Box 
				borderBottom={1}
				px={px}
          ...
          onChange={() => { 
			...
			>
				...
				<Button 
					width={250}
				onClick={ () => pEditInviteAccessLink(id, accessLink)}>Add Access link</Button>
			</Box>
			<Box
				px={px}
				py={py}
			...
			>
				...
				<Button 
					width={250}
				onClick={ () => pEditInviteRadius(id, radius)}>Add Radius</Button>
			</Box>
			<Box 
				borderBottom={1}
				px={px}
